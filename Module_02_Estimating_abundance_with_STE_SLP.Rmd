...
Note that you can use the "Motion Sensor Format" of the deploy frame here as well, and it should give you a similar result. The "Timelapse Format" is recommended because any missing photos are interpreted as camera malfunctions rather than counts of 0, and you have more flexibility to specify camera area and functionality.
